...
# Coding Trials and Errors (Emphasis on the Latter)

Below is a basic breakdown of the coding I attempted to do involving the first stanza of the Odyssey. Basing my start on some of the structure of the Frankenstein Variorum (FV), I outlined the following process: 

* Acquire the text for each version/translation of the text in .txt files 
* Make the text machine-readable, and add in milestone markers of some kind to flag lines, stanzas, and other important groupings (XML, TEI markup language)
* Create an XSLT stylesheet to flatten and transform the XML into...well, something (ended up being HTML)
* Profit? 

To get better acquainted with XML TEI Markup language, I used the TEIGarage Conversion site that was linked on the TEI documentation website to produce versions of each text. The output for this was helpful, but was all in one line, which showed me how placing in milestone markers on my own would be important - to indicate line breaks, at a minimum. 

Milestone markers that I identify to bake into the XML were: lines, books, and stanzas. I modeled several XML documents after the FV's structure, to learn how to use XML syntax to add these milestones in. 

There was a portion of the semester when I departed from the Frankenstein Variorum to explore what other projects that involved translations of texts did to align them together. While this was interesting, I sort of regret how deep down the rabbit hole I went. I learned about some pretty amazing projects (some of which are in my Zotero library), and some cool Python packages (check out LingPy if you want to go down a similar rabit hole), this put my computation work to a halt because of decision paralysis, and further lack of understanding of how to implement some of the computational elements I was reading about. 

Keeping it simple, here is a basic Python table that puts the lines of text alongside one another (with N/A's in place to account for the Wilson translation having an extra line): 

<img width="1253" height="376" alt="image" src="https://github.com/user-attachments/assets/862f4283-900f-41a3-a857-4a4f8812e770" />

After that is when things started to fall apart.(Well, it also fell apart a bit beforehand. The one class on Python I had taken in Spring 2024 was very useful to me; however, I had a PC at the time, not a Mac, which is what I have now. I knew that some aspects would be different when approaching this from a new machine, but vastly underestimated how much of a challenge that would be for me. Talk about humbling.) 

I knew conceptually what I wanted to accomplish through code after meeting with Ben over office hour: creating an alignment table of some kind. The Frankenstein Variorum had a very complex process to produce their site and Variorum Viewer, which I did not have the time or resources to accomplish. I decided to simplify the process based on my discussion with Ben, and shoot for creating an HTML alignment table of the texts that can be viewed in web browser. I did not have much success at this. My partner, who is much more familiar with code than I am, was able to help me to a certain point, but on my own, I knew that I was not going to be able to pull off what I had set out to do. 

Knowing that I only had a finite amount of time left to dedicate to this part of the project, and knowing LLM/AI's potential ability to produce code, I decided to use Gemini to see what HTML output it would develop. I also decided that this would become a part of my pivot into prototyping, and be an opportunity for me to both learn what the tool could look like, and what Gemini was capable of producing. I don't have experience outside of this asking Gemini to provide code or complicated output like this, so I put a lot of thought into the prompt that I was going to use. I'm thankful for the experience I gained from Alison's guest lectures, and how it informed me when it came to creating a prompt. 

Gemini's product was much more successful than any attempt of mine that were hodgepodged from various forms of documentation, and example code I found from other projects, such as FV (I did find out about lxml through that process, though, so I'm glad I gained that, at least. There are two sources about lxml in my Zotero library): 


<img width="1468" height="823" alt="image" src="https://github.com/user-attachments/assets/5784933c-c42d-422f-af6f-0fb9c3df5398" />

<img width="1468" height="823" alt="image" src="https://github.com/user-attachments/assets/e5c32091-1da7-4747-b64b-c2e9619d3670" />


The output from Gemini was not perfect, but I didn't need it to be in order to gain insight from it as a prototype. The prototype had an ability to toggle color visibility on and off, and presented the texts alongside each other in a way that was clean. Some of the final lines of the English translations were not properly colored/accounted for, and other smaller mistakes were present, but the basic functionality did help me think about potential choices and directions for further prototyping. 
 
This is where I officially accepted defeat, code-wise, and acknowledged that I needed to move on. I tried. I did learn more about navigating code documentation, properly forming a Gemini prompt, and about my own patience (or lack thereof). Though I may know conceptually what I want to do with code, execution is another story, and I have to accept that as being fine (there's a reason I'm an archivist as opposed to a career related to compsci). I boohoo'd about this in my Mindful Practice Journal, and then shifted gears to more concentrated prototyping, which is described below. 
